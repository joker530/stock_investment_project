...
filename = "G:/ai/量化投资/交易框架的编写/backtesting_platform/datas_daily/002230.SZ.csv"
...
class DataFinanceDraw(object):
    ...
    def my_data(self, file_name='002624.SZ.csv'):
        ...
        """
        data = pd.read_csv("G:/ai/量化投资/交易框架的编写/backtesting_platform/datas_daily/002230.SZ.csv")
