...
class BacktestFrame(wx.Frame):
    def __init__(self, *args, **kw):
        ...
        self.frequency = wx.ComboBox(panel, value="day", choices=["day", "minute", "tick"])
        ...
        self.benchmark = wx.ComboBox(panel, value="沪深300 000300",
                                     choices=["上证指数 sh000001", "深证成指 sz399001", "创业板指 sz399006", "沪深300 sh000300"])
    ...
    def _get_benchmark(self):   # 返回选择的参考基准，类似于"沪深300 000300"
        benchmark_name = self.benchmark.GetValue()
